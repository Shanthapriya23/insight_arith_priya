        ...
        <div>
            <article>
                ...
                <div style={{ "margin-left": "200px" }}>
                    <p> <img style={{ 'margin-left': '0px' }} src={Num2bar} />=  2 x 1   +  (-9) x 10  +    7 x 100   +  (-3) x 1000</p>
                    <p>=-2388</p>
                </div>
                <div style={{ "margin-left": "200px" }}>
                    <p> <img style={{ 'margin-left': '0px' }} src={Num3bar} />    =  - (9x1 + 3x10 + 6x100)  +   4x1000  +  2x10000  +  7x100000</p>
                    <p>=-2388</p>
                </div>
                <div style={{ "margin-left": "200px" }}>
                    <p>similarly <img style={{ 'margin-left': '0px' }} src={Num4bar} />  =   77413</p>
                ...
                <div>
                    ...
                    <div style={{ "margin-left": "200px" }}>
                        ...
                        <p>=<img style={{ 'margin-left': '0px' }} src={Num5bar} /></p>
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div style={{ "margin-left": "200px" }}>
                        <p>-> <img style={{ 'margin-left': '0px' }} src={Num6bar} /> </p>
                        <p>-> <img style={{ 'margin-left': '0px' }} src={Num7bar} /> </p>
                    
                    </div>
                    <p >This process is similar to subtraction of 2 numbers with borrow. Doing the same for the hundreds digit '8', we get</p>
                    <div style={{ "margin-left": "200px" }}>
                    
                    <p>-> <img style={{ 'margin-left': '0px' }} src={Num8bar} /> </p>
                    <p>-> <img style={{ 'margin-left': '0px' }} src={Num9bar} /> </p>
                    <p>-> <img style={{ 'margin-left': '0px' }} src={Num10bar} /> </p>
                    </div>
